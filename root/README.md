...
A full-stack social posting app built as a class project and taken further with a full deployment. Three-tier architecture: **React**, **Express/Node.js**, and **PostgreSQL**.

**Live demo:** [https://meowlchat-g88n.onrender.com/](https://meowlchat-g88n.onrender.com/)
...
- React Hooks manage state; `useEffect` triggers backend requests on state change
